...
export default function PieceEnquiry({ piece }: { piece: Piece }) {
  ...
  const field =
    'w-full bg-transparent border-b border-line-strong py-2.5 text-body text-ink placeholder:text-muted/70 focus:border-clay focus:outline-none transition-colors duration-base';
